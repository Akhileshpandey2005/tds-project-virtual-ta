...
parser = argparse.ArgumentParser(description="Run the API app")
parser.add_argument(
    "--api-key",
    required=False,
    help="API key in the format 'Bearer <JWT>'"
)
args = parser.parse_args()
API_KEY = args.api_key or os.getenv("AIPIPE_API_KEY")
if not API_KEY:
    parser.error("API key not provided. Use --api-key or set AIPIPE_API_KEY env var.")
